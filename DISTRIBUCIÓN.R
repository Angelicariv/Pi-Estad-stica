...
# tienen una calificacion mayor a 7.

x1<-pnorm(7, mean=7.4, sd=1.6, lower.tail = FALSE)#______________ DISTRIBUCIÓN Z ______________
...
x1*100#______________ DISTRIBUCIÓN Z ______________
...
x1<-pnorm(7, mean=7.5, sd=1.71, lower.tail = FALSE)
x1*100
